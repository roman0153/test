  ...
  return (
    <>
      ...
      <div className="article-body privacy-body">
        ...
        <section><h2>Technické údaje a fotografie</h2><p>Dočasný limit odosielania využíva identifikátor odvodený od IP adresy poskytnutej hostingom. Aplikácia nepoužíva analytické ani reklamné cookies. Fotografie použité v ukážke sa získavajú z obrazového CDN služby Pinterest (i.pinimg.com) cez optimalizáciu obrázkov Next.js. Nie sú vložené prihlasovacie ani sledovacie widgety Pinterestu. Prevádzkovateľ hostingu, obrazového CDN a poskytovatelia doručovania môžu spracúvať technické údaje podľa svojich podmienok. Pred spustením odporúčame používať fotografie s overeným oprávnením na zverejnenie, uložené vo vlastnom úložisku.</p></section>
