    ...
    <>
      ...
      <section className="about-section section-space" aria-labelledby="about-title">
        <div className="container about-grid">
          ...
          <div className="about-image image-wrap" data-reveal="image" data-reveal-delay="1"><Image src={images.greenery} alt="Pokojná záhrada s bohatou zelenou výsadbou" fill sizes="(max-width: 760px) 90vw, 48vw" className="cover-image" /><span className="image-note">Prirodzene. Premyslene. Pre vás.</span></div>
        </div>
      </section>

      <section className="services-section" aria-labelledby="services-title">
        <div className="container">
          <div className="section-heading-line" data-reveal="up"><h2 className="eyebrow" id="services-title">Naše služby</h2><span className="quiet-note">Od prvej skice po každé ďalšie leto.</span></div>
      ...
      <section className="featured-work section-space" aria-labelledby="work-title">
        <div className="container featured-work-layout">
          <div className="featured-work-intro" data-reveal="up"><p className="eyebrow">Realizácie</p><h2 id="work-title">Inšpirácia<br />v každom detaile.</h2><TextLink href="/realizacie">Všetky realizácie</TextLink></div>
